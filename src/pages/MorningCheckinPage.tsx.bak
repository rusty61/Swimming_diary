...
const MorningCheckinPage: React.FC = () => {
  ...
  const [dataVersion, setDataVersion] = useState(0); // kept for consistency

  const handleMoodChange = (mood: MoodValue | null) => {
    console.log("Mood changed to:", mood);
  };

  // For now this just bumps the version; useful if you later hook it into stats
      ...
      <div className="max-w-7xl mx-auto py-8 z-10 relative">
        ...
        <main className="max-w-5xl mx-auto px-4 pb-24">
          ...
          <div className="mt-2 mb-4 grid grid-cols-1 gap-4 md:grid-cols-4 items-center">
            ...
            {/* 3. Update button (desktop/tablet) */}
        ...
        {/* Mobile sticky Update button (so it’s always reachable) */}
