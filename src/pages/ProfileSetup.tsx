    ...
    <div className="min-h-screen bg-background p-8 flex flex-col items-center justify-center">
      <Card className="w-full max-w-2xl mx-auto shadow-lg rounded-lg bg-card text-foreground border-card-border">
        <CardHeader className="text-center">
          <CardTitle className="text-3xl font-bold text-accent">Profile Setup</CardTitle>
          <CardDescription className="text-text-muted mt-2">
            Please provide your details to personalize your training experience.
          </CardDescription>
        </CardHeader>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input type="email" placeholder="your@example.com" {...field} disabled={!!user?.email} className="bg-input text-foreground border-border" />
                    </FormControl>
                    <FormDescription className="text-text-muted">
